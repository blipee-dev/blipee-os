    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="relative w-20 h-20">
          ...
          <div className="absolute inset-3 rounded-full bg-gradient-to-br from-yellow-500 to-orange-500 opacity-20 animate-pulse"></div>
        ...
        <div className="text-center">
          <p className="text-slate-300 font-semibold">Loading Energy Metrics</p>
          <p className="text-slate-500 text-sm mt-1">Analyzing consumption patterns...</p>
        </div>
