import { WaterIntensityMetrics } from '@/lib/data/gri'
import dashboardStyles from '../../dashboard.module.css'

interface WaterIntensityCardsProps {
  intensity: WaterIntensityMetrics
}

export function WaterIntensityCards({ intensity }: WaterIntensityCardsProps) {
    ...
    <div style={{
      ...
      {intensity.perEmployee !== null && (
        <div className={dashboardStyles.kpiCard}>
          <div className={dashboardStyles.kpiHeader}>
            ...
            <span className={dashboardStyles.kpiStandard}>GRI 303-1</span>
          </div>
          ...
          <div className={dashboardStyles.kpiUnit}>m³ / employee</div>
      ...
      {intensity.perRevenueMillion !== null && (
        <div className={dashboardStyles.kpiCard}>
          ...
          <div className={dashboardStyles.kpiUnit}>m³ / $M revenue</div>
          <div className={dashboardStyles.kpiTrend}>
      ...
      {intensity.perFloorAreaM2 !== null && (
        <div className={dashboardStyles.kpiCard}>
          ...
          <div className={dashboardStyles.kpiUnit}>m³ / m²</div>
          <div className={dashboardStyles.kpiTrend}>
