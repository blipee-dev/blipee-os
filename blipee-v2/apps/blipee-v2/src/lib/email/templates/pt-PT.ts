/**
 * Portuguese (European) Email Templates
 * pt-PT locale
 */
...
/**
 * Email Confirmation Template - Portuguese
 */
          ...
          <tr>
            <td style="padding: 0 40px 32px; text-align: center;">
              <p style="margin: 0 0 32px; font-size: 15px; line-height: 1.6; color: #525252;">
                ${name ? `Olá ${name}, ` : ''}Clique no botão abaixo para confirmar o seu endereço de email e ativar a sua conta:
              </p>
              ...
              <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #737373;">
                Esta ligação expira em 48 horas.
              </p>
            </td>
          </tr>
            ...
            <td style="padding: 0 40px 32px;">
              <div style="background-color: #f5f5f5; border-radius: 8px; padding: 16px;">
                <p style="margin: 0 0 8px; font-size: 13px; color: #737373; text-align: center;">
                  Ou copie e cole esta ligação no seu navegador:
                </p>
...
/**
 * Password Reset Template - Portuguese
 */
      ...
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" style="max-width: 500px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 0 40px 32px; text-align: center;">
              <p style="margin: 0 0 32px; font-size: 15px; line-height: 1.6; color: #525252;">
                Recebemos um pedido para redefinir a palavra-passe da sua conta (<strong>${email}</strong>). Clique no botão abaixo para criar uma nova palavra-passe:
              </p>
          ...
          <tr>
            <td style="padding: 32px 40px 48px; text-align: center; border-top: 1px solid #e5e5e5;">
              <p style="margin: 0 0 8px; font-size: 13px; color: #a3a3a3;">
                Se não solicitou a redefinição de palavra-passe, ignore este email e a sua palavra-passe permanecerá inalterada.
              </p>
              <p style="margin: 0; font-size: 13px; color: #a3a3a3;">
                © ${new Date().getFullYear()} blipee. Todos os direitos reservados.
              </p>
...
/**
 * Magic Link Template - Portuguese
 */
      ...
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" style="max-width: 500px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 0 40px 32px; text-align: center;">
              <p style="margin: 0 0 32px; font-size: 15px; line-height: 1.6; color: #525252;">
                Clique no botão abaixo para aceder à sua conta (<strong>${email}</strong>):
              </p>
          ...
          <tr>
            <td style="padding: 32px 40px 48px; text-align: center; border-top: 1px solid #e5e5e5;">
              <p style="margin: 0 0 8px; font-size: 13px; color: #a3a3a3;">
                Se não solicitou esta ligação, ignore este email.
              </p>
              <p style="margin: 0; font-size: 13px; color: #a3a3a3;">
                © ${new Date().getFullYear()} blipee. Todos os direitos reservados.
              </p>
...
/**
 * User Invitation Template - Portuguese
 */
          ...
          <tr>
            <td style="padding: 0 40px 32px; text-align: center;">
              <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: #525252;">
                <strong style="color: #0a0a0a;">${inviterName}</strong> convidou-o para se juntar a <strong style="color: #0a0a0a;">${organizationName}</strong> na blipee${role ? ` como <strong>${role}</strong>` : ''}.
              </p>
