    ...
    <>
      <aside className={`${styles.sidebar} ${isCollapsed ? styles.collapsed : ''}`}>
        <div className={styles.sidebarSection}>
          ...
          <Link href="/dashboard/analytics" className={styles.sidebarItem} data-tooltip={t('analytics')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M3 3v18h18" />
              <path d="M18 17V9" />
              <path d="M13 17V5" />
          ...
          <Link href="/dashboard/reports" className={styles.sidebarItem} data-tooltip={t('reports')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M12 20V10" />
              <path d="M18 20V4" />
              <path d="M6 20v-4" />
        ...
        <div className={styles.sidebarSection}>
          ...
          <Link href="/dashboard/energy/consumption" className={styles.sidebarItem} data-tooltip={t('consumption')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
            </svg>
            <span className={styles.sidebarItemText}>{t('consumption')}</span>
          </Link>
          <Link href="/dashboard/energy/cost" className={styles.sidebarItem} data-tooltip={t('costAnalysis')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link href="/dashboard/energy/efficiency" className={styles.sidebarItem} data-tooltip={t('efficiency')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link href="/dashboard/energy/goals" className={styles.sidebarItem} data-tooltip={t('goals')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className={styles.sidebarSection}>
          ...
          <Link href="/dashboard/gri/emissions" className={styles.sidebarItem} data-tooltip={t('gri305Emissions')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" />
            </svg>
            <span className={styles.sidebarItemText}>{t('gri305Emissions')}</span>
          </Link>
          <Link href="/dashboard/gri/energy" className={styles.sidebarItem} data-tooltip={t('gri302Energy')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
            </svg>
            <span className={styles.sidebarItemText}>{t('gri302Energy')}</span>
          </Link>
          <Link href="/dashboard/gri/water" className={styles.sidebarItem} data-tooltip={t('gri303Water')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" />
            </svg>
            <span className={styles.sidebarItemText}>{t('gri303Water')}</span>
          </Link>
          <Link href="/dashboard/gri/waste" className={styles.sidebarItem} data-tooltip={t('gri306Waste')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className={styles.sidebarSection}>
          ...
          <Link href="/dashboard/billing" className={styles.sidebarItem} data-tooltip={t('billing')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
            </svg>
            <span className={styles.sidebarItemText}>{t('billing')}</span>
          </Link>
          <Link href="/dashboard/integrations" className={styles.sidebarItem} data-tooltip={t('integrations')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M20 7h-9" />
              <path d="M14 17H5" />
          ...
          <Link href="/dashboard/settings" className={styles.sidebarItem} data-tooltip={t('settings')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
