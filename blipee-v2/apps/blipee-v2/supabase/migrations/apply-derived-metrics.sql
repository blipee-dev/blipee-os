-- Migration: Add support for derived/calculated metrics
-- This allows marking metrics that are automatically calculated from other metrics
-- For example: GRI 305-2 emissions calculated from electricity consumption
