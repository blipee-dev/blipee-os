...
- Governance metrics
- Financial data
- Social metrics (community, human rights)
...
async function main() {
  const pdfPath = '/tmp/plmj-puppeteer/report.pdf';
  const companyName = 'PLMJ (GRI Table 2023)';
  ...
  const filename = 'plmj-gri-2023.json';
  ...
  console.log(`\n📊 EXTRACTION:  ${metricCount} metrics from GRI table`);
}
