...
export class OnboardingService {
  ...
  private async createOrganization(
    ...
    await this.supabase.rpc("create_organization_with_owner", {
      ...
      org_data: {
        ...
        subscription_tier:
          data.subscription_selection?.subscription || "starter",
      },
    });
  }
  ...
  private async createBuildings(
    ...
    const buildings = this.parseBulkInput(
      "csv_building_parser",
      buildings_quick_add.input,
    );
  ...
  private async sendInvitations(
    ...
    const invites = this.parseBulkInput(
      "smart_invite_parser",
      invite_managers.input,
    );
    ...
    for (const invite of invites) {
      ...
      if (invite.building) {
        ...
        if (building) {
          ...
          await this.supabase.from("pending_assignments").insert({
            email: invite.email,
  ...
  private async updateBuildingDetails(
    data: Record<string, any>,
    userId: string,
  ): Promise<void> {
  ...
  private async createSystemBaseline(
    data: Record<string, any>,
    userId: string,
  ): Promise<void> {
  ...
  private async setupMonitoring(
    ...
    await this.supabase.from("monitoring_preferences").insert({
  ...
  private async updateUserProfile(
    ...
    if (data.profile_setup) {
      ...
      updates.notification_preference =
        data.profile_setup.notification_preference;
    }
  ...
  private async assignMaintenanceAreas(
    data: Record<string, any>,
    userId: string,
  ): Promise<void> {
  ...
  private async configureComfortZones(
    data: Record<string, any>,
    userId: string,
  ): Promise<void> {
