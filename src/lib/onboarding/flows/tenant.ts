  ...
  steps: [
    {
      ...
      content: {
        ...
        subtitle: "I'm Blipee, your building assistant. Let me help you get comfortable.",
        ...
        insights: [
          {
            ...
            template: "I'll keep {{unit_number}} at your preferred {{comfort_preference}} comfort level"
          },
          {
            type: 'quick_win',
            template: "Pro tip: Report issues through me for {{response_time}}% faster response"
          },
          {
            type: 'cost_estimate',
