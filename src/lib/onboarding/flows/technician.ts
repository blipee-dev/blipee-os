  ...
  steps: [
    {
      ...
      content: {
        template:
          "Welcome {{user_name}}! {{inviter_name}} added you to the {{building_name}} maintenance team.",
        ...
        insights: [
          {
            ...
            template:
              "I've found {{open_work_orders}} open work orders in your areas",
          },
          {
            type: "quick_win",
            template:
              "{{equipment_count}} pieces of equipment are due for PM this week",
          },
          {
            type: "cost_estimate",
            template:
              "Quick tip: {{top_issue}} is the most common issue in {{building_name}}",
          },
        ],
        cta: {
