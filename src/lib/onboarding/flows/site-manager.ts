  ...
  steps: [
    {
      ...
      required: true,
      content: {
        template: "Hi {{user_name}}! {{inviter_name}} invited you to manage {{building_name}}. I'm Blipee, your AI assistant.",
    ...
    },
    {
      ...
      config: {
        ...
        insights: [
          {
            type: 'cost_estimate',
            template: "Based on your {{size}} sq ft {{building_type}}, you're likely spending ${{estimated_monthly}} on energy"
          },
          {
            type: 'quick_win',
            template: "I can help reduce that by {{savings_percent}}% with {{top_recommendation}}"
          },
          {
