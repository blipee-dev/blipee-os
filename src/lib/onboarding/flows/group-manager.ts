  ...
  steps: [
    {
      ...
      content: {
        template:
          "Hi {{user_name}}! {{inviter_name}} invited you to manage groups at {{building_name}}.",
    ...
    },
    {
      ...
      config: {
        ...
        bulkPaste: true,
        placeholder:
          "admin@company.com = Office Admin\nit@company.com = IT Lead",
        skipOption: {
        ...
        insights: [
          {
            ...
            template:
              "I'll monitor {{group_location}} for optimal {{top_priority}}",
          },
          {
            type: "quick_win",
            template:
              "Based on {{team_size}} people, I can save {{estimated_savings}}% on energy during off-hours",
          },
          {
            type: "cost_estimate",
            template:
              "Your team's space typically costs ${{cost_per_person}}/person monthly to operate",
          },
        ],
        cta: {
