...
export const subscriptionOwnerFlow: OnboardingFlow = {
  ...
  steps: [
    ...
    },
    {
      ...
      config: {
        ...
        placeholder: "Main Office, Chicago\nWarehouse, Detroit\nBranch Office, New York",
    ...
    },
    {
      ...
      config: {
        ...
        bulkPaste: true,
        placeholder: "john@company.com = Main Office\nmary@company.com = Warehouse",
        skipOption: {
        ...
        options: [
          {
            ...
            price: '$49/month',
            features: ['Up to 2 buildings', 'Basic monitoring', '5 team members'],
            recommended: false
          },
          {
            value: 'professional',
            ...
            price: '$149/month',
            features: ['Up to 10 buildings', 'Advanced AI insights', '25 team members', 'Priority support'],
            recommended: true
          },
          {
            value: 'enterprise',
            ...
            features: ['Unlimited buildings', 'Custom integrations', 'Unlimited team members', 'Dedicated support'],
            recommended: false
          }
        ]
      }
  ...
  completionActions: [
    ...
    },
    {
      ...
      data: null,
      message: "Great! I'm analyzing your building portfolio and will have initial insights ready in a moment."
    }
  ]
}