...
describe('rate-limit-service API', () => {
  ...
  describe('GET /api/gateway/rate-limit-service.ts', () => {
    it('should return 200 for valid requests', async () => {
      const _request = new NextRequest('http://localhost:3000/api/gateway/rate-limit-service.ts');
    ...
    it('should handle query parameters', async () => {
      const _request = new NextRequest('http://localhost:3000/api/gateway/rate-limit-service.ts?limit=10&offset=0');
      const response = await GET(_request);
