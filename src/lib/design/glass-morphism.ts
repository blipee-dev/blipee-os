...
export const glassGradient = (
  gradientType: keyof typeof premiumTheme.colors.gradients,
) => ({
  ...glassBase,
...
export const glassClasses = {
  ...
  strong:
    "backdrop-blur-xl bg-white/[0.04] border border-white/[0.08] shadow-[0_8px_40px_rgba(0,0,0,0.2)]",
  hover:
    "hover:bg-white/[0.04] hover:border-white/[0.1] hover:shadow-[0_8px_40px_rgba(0,0,0,0.2)]",
  focus:
    "focus:border-white/[0.15] focus:shadow-[0_8px_40px_rgba(139,92,246,0.15)]",
};
