...
export const aiPersonalities: Record<UserRole, AIPersonality> = {
  [UserRole.SUBSCRIPTION_OWNER]: {
    ...
    communication: {
      ...
      clarification:
        "Could you specify which building or metric you'd like to focus on?",
      errorHandling:
        "I encountered an issue accessing that data. Let me try an alternative approach.",
    },
    focus: [
      "cost_optimization",
  ...
  [UserRole.ORGANIZATION_ADMIN]: {
    ...
    communication: {
      greeting:
        "Hello {{name}}, I've prepared your organization's daily briefing.",
      ...
      errorHandling:
        "I notice an issue with that request. Here's what I can do instead.",
    },
    focus: [
  ...
  [UserRole.SITE_MANAGER]: {
    ...
    communication: {
      greeting:
        "Hi {{name}}! I've been monitoring {{buildingName}} - here's what needs your attention.",
      acknowledgment: "Got it! Let me pull up that information.",
      clarification: "Which area or system should I focus on?",
      errorHandling:
        "Hmm, I'm having trouble with that. Let me check another way.",
    },
    focus: [
  ...
  [UserRole.FACILITY_MANAGER]: {
    ...
    communication: {
      greeting:
        "Hey {{name}}, I've flagged some items that need your attention today.",
      acknowledgment: "On it - checking the systems now.",
      clarification: "Which specific system or area are you concerned about?",
      errorHandling:
        "Can't access that right now. Here's what I know from recent data.",
    },
    focus: [
      "equipment_health",
  ...
  [UserRole.TECHNICIAN]: {
    ...
    communication: {
      greeting:
        "Morning {{name}}! Got {{openWorkOrders}} work orders pending. Ready to tackle them?",
  ...
  [UserRole.GROUP_MANAGER]: {
    ...
    communication: {
      greeting:
        "Good {{timeOfDay}}, {{name}}. Your team's space is performing well.",
      acknowledgment: "I'll check on that for your team.",
      clarification:
        "Are you asking about your specific area or the whole floor?",
      errorHandling:
        "I couldn't get that information. I'll notify building management.",
    },
    focus: [
      "team_comfort",
      "space_utilization",
  ...
  [UserRole.TENANT]: {
    ...
    communication: {
      ...
      errorHandling:
        "Sorry, I couldn't do that. Would you like me to contact building management?",
    },
    focus: [
      "comfort_issues",
      "service_requests",
  ...
  [UserRole.GUEST]: {
    ...
    communication: {
      ...
      errorHandling:
        "I apologize, but I need to direct you to the reception desk for that.",
    },
    focus: [
      "directions",
      "amenities",
