...
export class AIResponseFormatter {
  ...
  static formatGeneralResponse(topic: string): FormattedAIResponse {
    const responses: Record<string, FormattedAIResponse> = {
      greeting: {
        message:
          "Hey there! I'm Blipee, your building's AI assistant. I'm here to help you manage energy, comfort, and sustainability. What would you like to know about your building today?",
        suggestions: [
      ...
      help: {
        message:
          "I can help you with all aspects of building management! I monitor energy usage, control HVAC and lighting, generate reports, and find optimization opportunities. Just ask me anything - I'll understand natural language and provide visual insights when helpful.",
        suggestions: [
  ...
  static formatNaturalResponse(message: string): FormattedAIResponse {
    ...
    if (
      ...
      const action = lowerMessage.includes("turn on")
        ? "turn on"
        : lowerMessage.includes("turn off")
          ? "turn off"
          : "adjust";
      const target = lowerMessage.includes("light")
        ? "lights"
