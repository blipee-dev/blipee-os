/**
 * Client-safe suggestion generator
 * Provides role-based suggestions without server-side dependencies
 */
  ...
  switch (userRole) {
    case 'SUPER_ADMIN':
      ...
      suggestions.push(
        {
          id: 'system-overview',
          text: 'Show me system-wide sustainability metrics',
          icon: '🌐',
        ...
        },
        {
          ...
          text: 'Review all organizations compliance status',
          icon: '🏢',
        ...
        {
          id: 'system-health',
          text: 'Check AI agents performance metrics',
          icon: '🤖',
          agent: 'ESGChiefOfStaff',
          priority: 3,
          category: 'insight'
        ...
        {
          id: 'global-report',
          text: 'Generate platform-wide analytics report',
          icon: '📊',
          agent: 'ESGChiefOfStaff',
          priority: 4,
          category: 'report'
