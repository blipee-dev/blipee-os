  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: "1rem",
        boxShadow:
          "0 8px 32px rgba(0, 0, 0, 0.2), 0 0 32px rgba(139, 92, 246, 0.25)",
      }}
    >
      {/* Header */}
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center justify-between">
          ...
          {downloadable && (
            <button
              className="gradient-button flex items-center gap-2 px-4 py-2 rounded-lg transition-all"
              style={{
                ...
                typeof section.content === "object" && (
                  <div className="grid grid-cols-2 gap-4">
                    {Object.entries(section.content).map(([metric, value]) => (
                      <div
                        key={metric}
                        className="flex justify-between py-2 border-b border-surface"
                      >
