...
const COLORS_LIGHT = ['#0080FF', '#6750A4', '#059669', '#D97706', '#DC2626', '#DB2777']
...
export function ChartComponent({ title, chartType = 'line', data = [] }: ChartComponentProps) {
  ...
  return (
    <div className="glass-card glass-card-default light-mode:bg-white/70 light-mode:border-gray-200" style={{
      background: isLightMode ? 'rgba(255, 255, 255, 0.7)' : 'rgba(255, 255, 255, 0.02)',
      backdropFilter: 'blur(20px)',
      WebkitBackdropFilter: 'blur(20px)',
      border: `1px solid ${isLightMode ? 'rgba(0, 0, 0, 0.08)' : 'rgba(255, 255, 255, 0.05)'}`,
      borderRadius: '1rem',
      padding: '1.5rem',
      boxShadow: isLightMode ? '0 4px 16px rgba(0, 0, 0, 0.06)' : '0 4px 16px rgba(0, 0, 0, 0.15)',
    }}>
      {title && (
        <h3 className="text-lg font-medium text-white light-mode:text-gray-800 mb-4">{title}</h3>
      )}
