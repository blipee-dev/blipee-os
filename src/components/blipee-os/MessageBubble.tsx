...
import { Building2, User, Sparkles, FileText, Image, FileSpreadsheet, Download } from 'lucide-react'
                ...
                {message.attachments.map((file) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-sm text-white/80 light-mode:text-gray-700 flex-1">{file.name}</span>
