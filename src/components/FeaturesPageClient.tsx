...
export default function FeaturesPageClient({ 
  ...
  const featureCategories: FeatureCategory[] = [
    {
      icon: MessageSquare,
      title: t.features.categories.conversationalAI.title,
      description: t.features.categories.conversationalAI.description,
      gradient: "from-pink-500 to-purple-500",
      features: t.features.categories.conversationalAI.features,
    },
    {
      icon: ChartBar,
      title: t.features.categories.dynamicVisualization.title,
      description: t.features.categories.dynamicVisualization.description,
      gradient: "from-purple-500 to-indigo-500",
      features: t.features.categories.dynamicVisualization.features,
    },
    {
      icon: BarChart3,
      title: t.features.categories.sustainabilityTracking.title,
      description: t.features.categories.sustainabilityTracking.description,
      gradient: "from-indigo-500 to-blue-500",
      features: t.features.categories.sustainabilityTracking.features,
    },
    {
      icon: FileText,
      title: t.features.categories.documentIntelligence.title,
      description: t.features.categories.documentIntelligence.description,
      gradient: "from-purple-500 to-pink-500",
      features: t.features.categories.documentIntelligence.features,
    },
    {
      icon: Brain,
      title: t.features.categories.predictiveAnalytics.title,
      description: t.features.categories.predictiveAnalytics.description,
      gradient: "from-pink-500 to-violet-500",
      features: t.features.categories.predictiveAnalytics.features,
    },
    {
      icon: Shield,
      title: t.features.categories.enterpriseSecurity.title,
      description: t.features.categories.enterpriseSecurity.description,
      gradient: "from-violet-500 to-purple-500",
      features: t.features.categories.enterpriseSecurity.features,
    },
  ];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-lg sm:max-w-none mx-auto">
              ...
              >
                {t.features.cta.requestButton}
              </motion.button>
            </div>
            <p className="mt-6 text-white/70 text-sm">
              {t.features.cta.footer}
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {isContactModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t.features.contactModal.title}</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              {t.features.contactModal.subtitle}
            </p>
            
            <form className="space-y-4">
              <input
                type="text"
                placeholder={t.features.contactModal.namePlaceholder}
              ...
              <input
                type="email"
                placeholder={t.features.contactModal.emailPlaceholder}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none"
              />
              <input
                type="text"
                placeholder={t.features.contactModal.companyPlaceholder}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none"
              />
              <textarea
                placeholder={t.features.contactModal.messagePlaceholder}
                rows={4}
              ...
              >
                {t.features.contactModal.submitButton}
              </button>
            </form>
          </motion.div>
        </div>
      ...
      {isSupportModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t.features.supportModal.title}</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              {t.features.supportModal.subtitle}
            </p>
            
            <form className="space-y-4">
              <input
                type="text"
                placeholder={t.features.supportModal.namePlaceholder}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none"
              />
              <input
                type="email"
                placeholder={t.features.supportModal.emailPlaceholder}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none"
              />
              <select
                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none"
              >
                <option value="" className="bg-white dark:bg-[#212121]">{t.features.supportModal.issueTypePlaceholder}</option>
                <option value="technical" className="bg-white dark:bg-[#212121]">{t.features.supportModal.issueTypes.technical}</option>
                <option value="billing" className="bg-white dark:bg-[#212121]">{t.features.supportModal.issueTypes.billing}</option>
                <option value="feature" className="bg-white dark:bg-[#212121]">{t.features.supportModal.issueTypes.feature}</option>
                <option value="other" className="bg-white dark:bg-[#212121]">{t.features.supportModal.issueTypes.other}</option>
              </select>
              <textarea
                placeholder={t.features.supportModal.descriptionPlaceholder}
                rows={4}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none resize-none"
              />
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg transition-all"
              >
                {t.features.supportModal.submitButton}
              </button>
            </form>
          </motion.div>
        </div>
