...
export async function GET(
  ...
  try {
    ...
    const buildings = await organizationService.getOrganizationBuildings(params.id)
...
export async function POST(
  ...
  try {
    ...
    const building = await organizationService.createBuilding(params.id, validated)
