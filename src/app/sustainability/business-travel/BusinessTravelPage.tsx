...
import { BusinessTravelDashboard } from '@/components/dashboard/BusinessTravelDashboard';
...
export default function BusinessTravelPage() {
  ...
  const t = useTranslations('sustainability.businessTravel');
      ...
      <SustainabilityLayout>
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="text-center space-y-4">
            ...
            />
            <p className="text-gray-400">Loading business travel data...</p>
          </div>
        </div>
      </SustainabilityLayout>
    );
      ...
      <SustainabilityLayout>
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold">Error Loading Business Travel Data</h3>
          ...
          <div className="flex items-center justify-between gap-6 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                {t('title') || 'Business Travel'}
              </h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                {t('subtitle') || 'Employee business travel emissions by air, rail, and road (Scope 3.6)'}
              </p>
            </div>
