...
export default function FleetPage() {
  ...
  const t = useTranslations('sustainability.fleet');
      ...
      <SustainabilityLayout>
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold">Error Loading Fleet Data</h3>
          ...
          <div className="flex items-center justify-between gap-6 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                {t('title') || 'Fleet Management'}
              </h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                {t('subtitle') || 'Company vehicle emissions and fuel efficiency tracking (Scope 1)'}
              </p>
            </div>
