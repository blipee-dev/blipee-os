...
export default function TransportationPage() {
  ...
  const t = useTranslations('sustainability.transportation');
      ...
      <SustainabilityLayout>
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="text-center space-y-4">
            ...
            />
            <p className="text-gray-400">Loading transportation data...</p>
          </div>
        </div>
      </SustainabilityLayout>
    );
      ...
      <SustainabilityLayout>
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold">Error Loading Transportation Data</h3>
          ...
          <div className="flex items-center justify-between gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                {t('subtitle') || 'Fleet, business travel, commuting, and logistics emissions tracking'}
              </p>
            </div>
