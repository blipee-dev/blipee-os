...
export const metadata: Metadata = {
  ...
  description:
    "Revolutionary building management through conversational AI. No dashboards. No menus. Just conversation.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-black overflow-hidden transition-colors duration-300`}
      >
        <AuthProvider>
