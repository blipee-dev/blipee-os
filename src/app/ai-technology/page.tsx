      ...
      <div className="space-y-2">
        ...
        {features.length > 3 && (
          <button
            ...
            className="flex items-center mt-3 text-sm text-purple-400 hover:text-purple-300 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-transparent rounded-lg px-3 py-2 min-h-[48px]"
          >
            {isExpanded ? (
              <>
