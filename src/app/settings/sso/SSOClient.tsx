          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <Shield className="h-12 w-12 text-[#757575] mx-auto mb-4" />
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
                  No SSO providers configured
                </h3>
                <p className="text-[#616161] dark:text-[#757575] mb-4">
              ...
              <div className="space-y-4">
                {configurations.map((config) => (
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="p-4 rounded-lg bg-gray-50 dark:bg-[#212121]/50 border border-gray-200 dark:border-white/[0.05]">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-xs px-2 py-1 rounded-full bg-gray-200 dark:bg-[#212121] text-[#616161] dark:text-[#757575]">
                            ...
                            {config.enabled ? (
                              ...
                              <span className="flex items-center gap-1 text-xs text-[#616161] dark:text-[#757575]">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            {config.protocol === 'oidc' && config.oidcConfig && (
                              <>
                                <div>
                                  <span className="text-[#616161] dark:text-[#757575]">Client ID:</span>
                                  <span className="ml-2 text-gray-900 dark:text-white truncate">
                                    {config.oidcConfig.client_id}
                                  </span>
                                </div>
                                <div>
                                  <span className="text-[#616161] dark:text-[#757575]">Issuer:</span>
                                  <span className="ml-2 text-gray-900 dark:text-white truncate">
                          ...
                          {testingConfig === config.id ? (
                            ...
                            <>
                              <button
                                ...
                                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/[0.05] text-[#616161] dark:text-[#757575]"
      ...
      >
        <GlassCard>
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-sm text-[#616161] dark:text-[#757575]">
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white mb-2">SAML 2.0</h3>
                <ul className="space-y-1 list-disc list-inside ml-4">
                  <li>Assertion Consumer Service URL: <code className="text-xs bg-gray-100 dark:bg-[#212121] px-2 py-1 rounded">{process.env['NEXT_PUBLIC_APP_URL']}/api/auth/sso/saml/callback</code></li>
                  <li>Entity ID: <code className="text-xs bg-gray-100 dark:bg-[#212121] px-2 py-1 rounded">{process.env['NEXT_PUBLIC_APP_URL']}</code></li>
              ...
              <div>
                ...
                <ul className="space-y-1 list-disc list-inside ml-4">
                  <li>Redirect URI: <code className="text-xs bg-gray-100 dark:bg-[#212121] px-2 py-1 rounded">{process.env['NEXT_PUBLIC_APP_URL']}/api/auth/sso/oidc/callback</code></li>
