          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm">We implement enterprise-grade security measures to protect your personal information.</p>
              </div>
              <div className="bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-xl p-6">
                <div className="flex items-center mb-3">
                ...
                <p className="text-gray-600 text-sm">We're clear about what data we collect, why we collect it, and how we use it.</p>
              </div>
              <div className="bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-xl p-6">
                <div className="flex items-center mb-3">
                ...
                <p className="text-gray-600 text-sm">We only collect and process data that's necessary to provide our services.</p>
              </div>
              <div className="bg-gray-50 backdrop-blur-xl border border-gray-200 rounded-xl p-6">
                <div className="flex items-center mb-3">
                ...
                <p className="text-gray-600 text-sm">You have full control over your personal data with rights to access, modify, and delete.</p>
              </div>
            </div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <section className="mb-8">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">1.2 Information We Collect Automatically</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">6.1 GDPR Rights (EU Users)</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">6.2 CCPA Rights (California Users)</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
